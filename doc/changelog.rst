...
Description:
 ...
 - Added Ray cluster setup and deployment (SmartSim-PR50_)
 - Improved code coverage by adding more unit tests (SmartSim-PR53_)
 - Added the ability to retrieve database addresses in a formatted way with the Orchestrator's get_address method (SmartSim-PR60_)
 - Added Manifest object to keep track of all deployables generated by an experiment (SmartSim-PR61_)
 - Added LSF launcher capabilities (SmartSim-PR62_)
 - Bug fixes (SmartSim-PR52_) (SmartSim-PR58_) (SmartSim-PR67_) (SmartSim-PR73_)
 - Upgraded RedisAI backend to 1.2.3, streamlined installation, and reduced dockerfile sizes (SmartSim-PR69_)
 - Updated documentation and added many examples (SmartSim-PR51_) (SmartSim-PR57_) (SmartSim-PR71_)
 - Improved RedisIP info parsing (SmartSim-PR72_)
