...
.. code-block:: python
   ...
   # init experiment
   experiment= Experiment(experiment="h2o", log_level="DEBUG")

   # create ensembles
   ensemble_params = {"STEPS": [10, 15, 20, 25]}
   experiment.create_ensemble("h2o-1", params=ensemble_params)


   # Data Generation Phase
   gen = Generator(experiment, model_files="CP2K/h2o.inp")
   gen.generate()
   ...
   sim_params = {"launcher": "slurm",       # setup slurm
                ...
                "exe_args": "-i h2o.inp",
                "nodes": 1}
   sim = Controller(experiment, **sim_params)
