...
exclude_patterns = [
    ...
    ".DS_Store",
    "**.ipynb_checkpoints",
    "tutorials/ml_training/surrogate/README.md",
    "tutorials/online_analysis/lattice/README.md",
]
...
if os.environ.get("READTHEDOCS") == "True":
    ...
    with open("./robots.txt", "w") as f:
        f.write(
            "# Disallow crawling of the Read the Docs URL\nUser-agent: *\nDisallow: /en/"
        )
...
slack_invite = (
    "https://join.slack.com/t/craylabs/shared_invite/zt-nw3ag5z5-5PS4tIXBfufu1bIvvr71UA"
)
extra_footer = (
    'Questions? You can contact <a href="mailto:craylabs@hpe.com">contact us</a> or '
...
def setup(app):
    ...
    members = inspect.getmembers(
        app.extensions["sphinx_autodoc_typehints"].module, _is_sphinx_logger_adapter
    )
