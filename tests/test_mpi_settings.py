...
def test_openmpi_base_args():
    ...
    settings = _BaseMPISettings("python", run_args=run_args)
    formatted = settings.format_run_args()
...
def test_format_env():
    ...
    settings = _BaseMPISettings("python", env_vars=env_vars)
