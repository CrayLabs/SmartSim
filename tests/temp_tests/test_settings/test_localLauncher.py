...
#         key2: val2,
#     }
#     localLauncher = LaunchSettings(launcher=LauncherType.LocalLauncher, launch_args=default_launcher_args)
...
def test_format_launch_args():
    localLauncher = LaunchSettings(launcher=LauncherType.LocalLauncher, launch_args={"-np": 2})
...
def test_format_env_vars():
    ...
    assert isinstance(localLauncher._arg_translator, LocalArgTranslator)
