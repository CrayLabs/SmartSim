...
def test_ensemble_random():
    ...
    ensemble = exp.create_ensemble("random",
                                   params=param_dict,
...
def test_ensemble_stepped():
    ...
    ensemble = exp.create_ensemble("step",
                                   params=params,
                                   perm_strategy="step",
                                   run_settings=gen_run_settings)
    ensemble.attach_generator_files(to_configure="./test_configs/in.atm")
...
def test_user_strategy():
    ...
    ensemble = exp.create_ensemble("user",
                                   params=params,
                                   perm_strategy=step_values,
                                   run_settings=gen_run_settings)
    ensemble.attach_generator_files(to_configure="./test_configs/in.atm")
    gen.generate_experiment(ensemble)
...
def test_full_exp():
    ...
    ensemble = exp.create_ensemble("test_ens", params=params, run_settings=gen_run_settings)
    ensemble.attach_generator_files(to_configure="./test_configs/in.atm")
...
def test_dir_files():
    ...
    ensemble = exp.create_ensemble("dir_test", params=params, run_settings=gen_run_settings)
...
def test_full_path():
    ...
    ensemble = exp.create_ensemble("full_path", params=params, run_settings=gen_run_settings)
