...
pytestmark = pytest.mark.skipif(not should_run, reason="requires tensorflow/keras",
)
...
def test_keras_model(fileutils, mlutils, wlmutils):
    ...
    run_settings = wlmutils.get_run_settings("python", f"run_tf.py --device={test_device}")
