#!/bin/bash -x
#PBS -N resv_job
#PBS -l select=1:ncpus=4:mpiprocs=4+1:ncpus=1:mpiprocs=1
##PBS -l gpu_type=v100
...
db_jobid=$(qsub -q $rsvname -v CESM_ROOT launch_database_cluster.py)
...
SSDB="$(getent hosts ${head_host}.ucar.edu |awk '{print $1}'):6780"
export SSDB
...
mpirun -np 4 ./smartredis_put_get_3D

sleep 10
EOF

qsub -l walltime=00:20:00 -AP93300606 -q $rsvname -v SSDB ./sr.cmd
# clean up
