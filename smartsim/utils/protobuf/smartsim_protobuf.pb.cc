...
static bool dynamic_init_dummy_smartsim_5fprotobuf_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_smartsim_5fprotobuf_2eproto)), true);
namespace SmartSimProtobuf {
