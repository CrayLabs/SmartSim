program array_2d_unit_test
  ...
  call put_array(smartsim_client,key_prefix//"test_array_2d_real_4",true_array_2d_real_4)
  call get_array(smartsim_client,key_prefix//"test_array_2d_real_4",recv_array_2d_real_4)
  call check_value(real4_0,SUM(true_array_2d_real_4-recv_array_2d_real_4),"put/get_"//key_prefix//"test_array_2d_real_4")

  call RANDOM_NUMBER(random_array_2d_for_real_8)
  true_array_2d_real_8 = random_array_2d_for_real_8*1000
  call put_array(smartsim_client,key_prefix//"test_array_2d_real_8",true_array_2d_real_8)
  call get_array(smartsim_client,key_prefix//"test_array_2d_real_8",recv_array_2d_real_8)
  call check_value(real8_0,SUM(true_array_2d_real_8-recv_array_2d_real_8),"put/get_"//key_prefix//"test_array_2d_real_8")

  call RANDOM_NUMBER(random_array_2d_for_integer_4)
  true_array_2d_integer_4 = random_array_2d_for_integer_4*1000
  call put_array(smartsim_client,key_prefix//"test_array_2d_integer_4",true_array_2d_integer_4)
  call get_array(smartsim_client,key_prefix//"test_array_2d_integer_4",recv_array_2d_integer_4)
  call check_value(integer4_0,SUM(true_array_2d_integer_4-recv_array_2d_integer_4),"put/get_"//key_prefix//"test_array_2d_integer_4")

  call RANDOM_NUMBER(random_array_2d_for_integer_8)
  true_array_2d_integer_8 = random_array_2d_for_integer_8*1000
  call put_array(smartsim_client,key_prefix//"test_array_2d_integer_8",true_array_2d_integer_8)
  call get_array(smartsim_client,key_prefix//"test_array_2d_integer_8",recv_array_2d_integer_8)
  call check_value(integer8_0,SUM(true_array_2d_integer_8-recv_array_2d_integer_8),"put/get_"//key_prefix//"test_array_2d_integer_8")

  call MPI_Finalize(err_code)
  if (num_failed > 0) stop -1
end program array_2d_unit_test
