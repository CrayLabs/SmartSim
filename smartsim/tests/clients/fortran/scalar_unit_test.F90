program scalar_unit_test
  ...
  call put_scalar(smartsim_client,key_prefix//"test_scalar_real_4",true_scalar_real_4)
  call get_scalar(smartsim_client,key_prefix//"test_scalar_real_4",recv_scalar_real_4)
  call check_value(true_scalar_real_4,recv_scalar_real_4,"put/get_"//key_prefix//"test_scalar_real_4")

  true_scalar_real_8 = 3.125
  call put_scalar(smartsim_client,key_prefix//"test_scalar_real_8",true_scalar_real_8)
  call get_scalar(smartsim_client,key_prefix//"test_scalar_real_8",recv_scalar_real_8)
  call check_value(true_scalar_real_8,recv_scalar_real_8,"put/get_"//key_prefix//"test_scalar_real_8")

  true_scalar_integer_4 = 3
  call put_scalar(smartsim_client,key_prefix//"test_scalar_integer_4",true_scalar_integer_4)
  call get_scalar(smartsim_client,key_prefix//"test_scalar_integer_4",recv_scalar_integer_4)
  ...
  call put_scalar(smartsim_client,key_prefix//"test_scalar_integer_8",true_scalar_integer_8)
  call get_scalar(smartsim_client,key_prefix//"test_scalar_integer_8",recv_scalar_integer_8)
