...
def poll_and_check_scalar(key_suffix, pollFunction, value, source):
    ...
    match_found = client.poll_exact_key(key, poll_frequency=100,
                                        num_tries=30)
...
if __name__ == "__main__":
    ...
    # Float64
    poll_check_function = Client.poll_exact_key_and_check_scalar_float64
    # Float64 (max value)
    suffix = "_dbl_max"
    ...
    #Int64
    poll_check_function = Client.poll_exact_key_and_check_scalar_int64
    # Int64 (max value)
    suffix = "_i64_max"
    ...
    #Int32
    poll_check_function = Client.poll_exact_key_and_check_scalar_int32
    # Int32 (max value)
    suffix = "_i32_max"
    value = 2147483647
    poll_and_check_scalar(suffix, poll_check_function, value, source)
